...
class Student(Person):
    ...
    def updateAddress(self, updatedAddr):
        Person.updateAddress(self, updatedAddr)
        return True
    ...
    def __repr__(self):
        return "RollNo: {0}\nName: {1}\nAddress:{2}\nDOB: {3}\nCourse: {4}\nDivision: {5}\nMarks: {6}".format(str(self.__rollNo),str(self.getName()),str(self.getAddress()),str(self.getDob()), str(self.__course), str(self.__division), str(self.__marks))
